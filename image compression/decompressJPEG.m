function decompressed = decompressJPEG(coded_arr,dict,cb,cr,dgree_of_compression,blocksize)
%this function takes as input a JPEG coded stream of bits, the Huffman
%dictionary used when encoding it,the cb and cr components, a degree of compression 0 for low
...
if length(cr)>1
    decompressed = YCbCr_to_RGB(decompressed, cb,cr);
